  ...
  <section id="home"
    ...
    >
      <div className={
        ...
        <img src={discount} className="w-8 h-8" alt="discount" />
      ...
      <div className='flex flex-row justify-between items-center w-full'>
        <h1 className='flex-1 font-poppins font-semibold ss:text-7xl text-[52px] text-white ss:leading-[100px] leading-[75px]'>The Next <br className='sm:block hidden' />{' '}
